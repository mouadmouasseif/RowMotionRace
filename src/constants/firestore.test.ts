...
describe("collections partagées", () => {
  it("utilise les noms RowMotion AI fournis", () => {
    expect(ROWMOTION_COLLECTIONS).toMatchObject({ users: "users", athletes: "athletes", coaches: "coaches", clubs: "clubs", federations: "federations", categories: "categories", notifications: "notifications" });
  });
