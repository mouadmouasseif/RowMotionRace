...
export const subscribeExistingClubs = (onChange: (clubs: RowMotionClub[]) => void, onError?: (error: Error) => void, maximum = 500) =>
  subscribeCollection(ROWMOTION_COLLECTIONS.clubs, normalizeClub, onChange, onError, maximum);
