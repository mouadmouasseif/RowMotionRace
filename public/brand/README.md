# Identité RowMotion Race

Les images de cette enveloppe sont les fichiers officiels fournis pour l'interface :

- `rowmotion-race-icon.png` : icône carrée pour mobile et favicon ;
